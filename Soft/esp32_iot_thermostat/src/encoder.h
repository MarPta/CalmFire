/* Encoder library and class serve for measuring frequency and counting revolutions of
a quadrature encoder. The class is aimed to be used on Mickoflus
...
#define MAX_ENGINE_PERIOD 100000    //encoder period limit separating zero result [us]
#define MIN_ENGINE_PERIOD 1000      //encoder period limit separating zero results [us]

const pcnt_unit_t pcntUnits[8] = {
    PCNT_UNIT_0,    //encoder1
    PCNT_UNIT_1,    //encoder2
    PCNT_UNIT_2, 
    PCNT_UNIT_3, 
    PCNT_UNIT_4, 
    PCNT_UNIT_5, 
...
const uint8_t encPins[16] = {
    21, 19,     //encoder1 - ENC1A, ENC1B
    18, 5,      //encoder2 - ENC2A, ENC2B
    17, 16,     //encoder3 - ENC3A, ENC3B
    15, 13,     //encoder4 - ENC4A, ENC4B
    4, 14,      //encoder5 - ENC5A, ENC5B
    27, 26,     //encoder6 - ENC6A, ENC6B
    25, 33,     //encoder7 - ENC7A, ENC7B
    32, 35      //encoder8 - ENC8A, ENC8B
};
...
public:
    Encoder(uint8_t index);    //motorEncoder slot index 1-8 as parameter
